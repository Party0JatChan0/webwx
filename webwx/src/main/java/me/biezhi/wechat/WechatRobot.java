...
public class WechatRobot {
	...
	private int tip = 0;
	private int automsgflag = 0;
	private String automsg = "自动回复";
	...
	public void start() throws WechatException {
		...
		// 监听消息
		LOGGER.info("是否开启自动回复？[1/0]");
		Scanner sc1 = new Scanner(System.in);
		String str1 = sc1.nextLine();
		if(str1.equals("1")){
			LOGGER.info("请设置自动回复的内容");
			Scanner sc2 = new Scanner(System.in);
			String str2 = sc2.nextLine();
			if(str2 != null){
				automsgflag = Integer.parseInt(str1);
				automsg = str2;
			}
		}
		wechatListener.start(wechatService, wechatMeta, automsgflag, automsg);
	}
